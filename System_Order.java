  ...
  public String calculate(){
        ...
        if (jumlah_Beli >= 0 && jumlah_Beli1 >= 0 && jumlah_Beli2 >= 0) {
            ...
            jumlah_Beli2 = Integer.parseInt(sp_jumlah_drinks.getValue().toString());
             totalpaket=(hitungCombo(jumlah_Beli, Harga));
            totalalacarte=(hitungAlaCarte(jumlah_Beli1, Harga1));
            totalminuman=(hitungMinuman(jumlah_Beli2, Harga2));
...
return null;
    ...
    private void initComponents() {
        ...
        jPanel4.add(btn_ok_frame2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 610, 110, 30));
        ...
        jPanel4.add(btn_reset_frame2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 610, 90, 30));
        ...
        jPanel4.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 0, -1, -1));

        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 450, 710));
        ...
        jPanel2.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 80, 250, 50));
        ...
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 30, 300, 80));

        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-80, -40, 1130, 120));
        ...
        jPanel6.add(btn_bayar_frame2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 330, 90, 30));

        jPanel2.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 130, 450, 490));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 30, 1030, 730));
...
public int hitungCombo(int firstNumber, int secondNumber){
    return firstNumber*secondNumber;
}
public int hitungAlaCarte(int firstNumber, int secondNumber){
    return firstNumber*secondNumber;
}
public int hitungMinuman(int firstNumber, int secondNumber){
    return firstNumber*secondNumber;
}
